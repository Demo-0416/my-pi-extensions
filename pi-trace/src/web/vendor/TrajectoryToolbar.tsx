...
import type { NS, TrajectoryKey } from './locales.ts'

/** pi-trace: dsh 的 TranslateNS 由本扩展的 locale 字典替代。 */
type TranslateNS<_Namespace extends string> = (key: TrajectoryKey) => string
import { IconSearchOutline16 } from '../primitives/icons.tsx'
